...
int main(int argc, char **argv) {
    ...
    mAccelerator.push_back(make_unique<Accelerator>(0x02, 1, true));
    mAccelerator.push_back(make_unique<Accelerator>(0x02, 2, true));
    mAccelerator.push_back(make_unique<Accelerator>(0x02, 3, true));
    mAccelerator.push_back(make_unique<Accelerator>(0x02, 4, true));
    ...
    if (model == MODEL_SSD_MOBILENET_V1) {
        ...
        vector<V1BinConfig*> group_efficientdet = {
            new V1BinConfig(CoreName::Core1,
                ...
                "ssdmobilenet/clmem.bin",
                "ssdmobilenet/dlmem.bin",
