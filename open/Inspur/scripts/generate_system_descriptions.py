...
# The DGX-A100-640G MIG (2GPC)
SJC1_LUNA_02_MIG_2 = Machine(
    status = Status.AVAILABLE,
    host_processor_model_name = "AMD EPYC 7742",
    host_processors_per_node = 2,
    host_processor_core_count = 64,
...
# The DGX-A100-640G MIG (3GPC)
SJC1_LUNA_02_MIG_3 = Machine(
    status = Status.AVAILABLE,
    host_processor_model_name = "AMD EPYC 7742",
    host_processors_per_node = 2,
    host_processor_core_count = 64,
...
GIGABYTE_EPYC_01 = Machine(
    ...
    hw_notes = "",
    system_id_prefix = "",
    system_name_prefix = "Gigabyte G482-Z52",
)
# The A30x8 machine (MIG)
GIGABYTE_EPYC_01_MIG_1 = Machine(
    status = Status.PREVIEW,
    host_processor_model_name = "AMD EPYC 7742",
    host_processors_per_node = 2,
    host_processor_core_count = 64,
...
COMPUTELAB_RO_PROD_01 = Machine(
    ...
    host_storage_type = "NVMe SSD",
    accelerator_model_name = "NVIDIA A100-SXM-80GB-275W",
    accelerator_short_name = "A100-SXM-80GB",
    mig_short_name = "",
    accelerator_memory_capacity = "80 GB",
    accelerator_memory_configuration = "HBM2e",
...
submission_systems = [
    ...
    System(IPP1_1469, Division.CLOSED, SystemType.DATACENTER, 8, 0, True, False), # A100-PCIex8-Triton
    System(IPP1_1469, Division.CLOSED, SystemType.DATACENTER, 8, 0, False, False, True), # A100-PCIex8-MaxQ
    System(IPP1_1469, Division.CLOSED, SystemType.DATACENTER, 8, 0, True, False, True), # A100-PCIex8-Triton-MaxQ
    ...
    System(GIGABYTE_EPYC_01, Division.CLOSED, SystemType.DATACENTER, 8, 0, False, False), # A30x8
    System(GIGABYTE_EPYC_01, Division.CLOSED, SystemType.DATACENTER, 8, 0, True, False), # A30x8-Triton
    System(GIGABYTE_EPYC_01_MIG_1, Division.CLOSED, SystemType.DATACENTER, 8, 4, True, False), # A30-MIG-32x1g.3gb-Triton
    ...
    System(SJC1_LUNA_02, Division.CLOSED, SystemType.DATACENTER, 8, 0, True, False, True), # A100-SXM-80GBx8-Triton-MaxQ
    System(SJC1_LUNA_02_MIG_1, Division.CLOSED, SystemType.DATACENTER, 8, 7, True, False), # A100-SXM-80GB-MIG-56x1g.10gb-Triton
    System(COMPUTELAB_RO_PROD_01, Division.CLOSED, SystemType.DATACENTER, 4, 0, False, False), # A100-SXM-80GB-275Wx4
    ...
    System(GIGABYTE_EPYC_01, Division.CLOSED, SystemType.EDGE, 1, 0, False, False), # A30x1
    System(GIGABYTE_EPYC_01, Division.CLOSED, SystemType.EDGE, 1, 0, True, False), # A30x1-Triton
    ...
    System(GIGABYTE_EPYC_01_MIG_1, Division.CLOSED, SystemType.EDGE, 1, 1, False, False), # A30-MIG-1x1g.3gb
    System(GIGABYTE_EPYC_01_MIG_1, Division.CLOSED, SystemType.EDGE, 1, 1, True, False), # A30-MIG-1x1g.3gb-Triton
    System(GIGABYTE_EPYC_01_MIG_1, Division.CLOSED, SystemType.DATACENTER, 1, 1, False, False, False, "HeteroMultiUse"), # A30-MIG-1x1g.3gb-HeteroMultiUse
