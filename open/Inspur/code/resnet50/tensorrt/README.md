...
The ONNX model *resnet50_inspur_open.onnx* is in the code/resnet50/tensorrt/ directory. You don't need to download.

### Model Description

This open model is generated by pruning. We prune the channel number of each layer to reduce the FLOPs and parameters.The pruned model size, FLOPs: 1.648G, Params: 10.78M. 
