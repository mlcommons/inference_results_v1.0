...
#from code.common import get_system_id
...
class ResNet50(BenchmarkBuilder):
    ...
    def __init__(self, args):
        ...
        # Model path
        self.model_path = dict_get(args, "model_path", default="code/resnet50/tensorrt/resnet50_inspur_open.onnx")
    ...
    def initialize(self):
        ...
        if self.device_type == "gpu" and self.precision == "int8" and not self.need_calibration:
            ...
            # Set dynamic of input
            input_tensor = self.network.get_input(0)
            input_tensor.dynamic_range= (-2.64064, 2.64064)
