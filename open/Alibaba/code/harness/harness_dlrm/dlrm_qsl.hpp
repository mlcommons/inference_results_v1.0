...
class DLRMSampleLibrary : public qsl::SampleLibrary {
  public:
    DLRMSampleLibrary(
        ...
        std::vector<int> samplePartition,
        size_t perfSampleCount,
        size_t perfPairCount,
        size_t padding = 0,
        ...
        bool startFromDevice = false) :
            ...
            qsl::SampleLibrary(name, mapPath, tensorPaths, perfPairCount,
                padding, coalesced, {startFromDevice, startFromDevice}),
    ...
    virtual size_t TotalSampleCount() override { return mTotalSampleCount; }
    virtual size_t PerformanceSampleCount() override { return mPerfSampleCount; }
    ...
    void* GetSampleAddress(mlperf::QuerySampleIndex sampleIdx, size_t inputIdx, size_t pairIdx = 0, size_t deviceIdx = 0)
    {
        return static_cast<char*>(sampleAddresses[(deviceIdx * mTotalSampleCount + sampleIdx) * m_NumInputs + inputIdx]) + pairIdx * qsl::SampleLibrary::GetSampleSize(inputIdx);
    }
