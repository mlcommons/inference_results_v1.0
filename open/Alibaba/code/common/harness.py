...
plugin_map = {
    BENCHMARKS.DLRM: ["build/plugins/DLRMInteractionsPlugin/libdlrminteractionsplugin.so",
                      ...
                      "build/plugins/smallTileGEMMPlugin/libsmalltilegemmplugin.so"],
    ...
    BENCHMARKS.ResNet50: ["code/resnet50/tensorrt/libautosiniancnnplugin_ampere.so" if pycuda.autoinit.device.compute_capability()[0] > 7 else "code/resnet50/tensorrt/libautosiniancnnplugin_turing.so"],                  
}
