...
class KnownSystems:
    ...
    A10 = SystemClass("A10", ["A10"], ["2236"], Architecture.Ampere, [1, 2])
    T4 = SystemClass("T4", ["Tesla T4", "T4 32GB"], ["1EB8", "1EB9"], Architecture.Turing, [1, 2, 8, 20])
