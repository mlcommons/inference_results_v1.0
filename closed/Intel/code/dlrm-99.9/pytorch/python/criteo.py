...
class Criteo(Dataset):
    ...
    def get_sample(self, idx):
        idx_offsets = [0]
        idx_offsets.append(idx_offsets[0] + self.items_in_memory_len[idx])
        X, lS_o, lS_i, T = self.items_in_memory[idx]
    ...
    def get_samples(self, id_list):
        ...
        num = 0
        for i in id_list:
            idx_offsets.append(idx_offsets[-1] + self.items_in_memory_len[i])
