# MLPerf Inference v1.0 Implementations for HPE Servers

This is a repository of implementations for HPE Servers, for [MLPerf Inference Benchmark](https://www.mlperf.org/inference-overview/).
...
## HPE Submission Systems

The system that HPE supports, has tested, and are submitting are:

 - Datacenter system
   - A100-SXM4-40GBx4 (HPE ProLiant XL645d Gen10 Plus, 40GB variant)

## General Instructions

:warning: **IMPORTANT**: Please use [closed/HPE](closed/HPE) (this directory) as the working directory when running any of the commands below. :warning:
...
**Note:** Inside the Docker container, [closed/HPE](closed/HPE) will be mounted at `/work`.

This section describes the steps needed to run harness with default configurations, weights, and validation datasets on HPE submission systems to reproduce.
...
Also, according to MLPerf Inference v1.0 rules, **ECC should be ENABLED for both GPU and CPU memories**.
...
See [calibration.md](calibration.md) for an explanation on how calibration is used for HPE's submission.
