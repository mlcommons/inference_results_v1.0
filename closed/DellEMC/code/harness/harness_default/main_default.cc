...
void doInference()
{
    ...
    sut_settings.ForceContiguous = test_settings.scenario == mlperf::TestScenario::MultiStream || FLAGS_assume_contiguous;
    ...
    const size_t padding = (test_settings.scenario == mlperf::TestScenario::MultiStream && test_settings.multi_stream_samples_per_query) ? (test_settings.multi_stream_samples_per_query - 1) : 0;
