...
class KnownSystems:
    ...
    R7525_QuadroRTX8000 = SystemClass("R7525_QuadroRTX8000", ["Quadro RTX 8000"], ["1E78"], Architecture.Turing, [3])
    R7525_VMware_A100_PCIe_40GB_x2 = SystemClass("vA100-PCIe-40GB", ["GRID A100-40C"], [], Architecture.Ampere, [1,2])
    XE2420_T4 = SystemClass("XE2420_T4", ["Tesla T4", "T4 32GB"], ["1EB8", "1EB9"], Architecture.Turing, [1,4])
    XE8545_A100_SXM4_40GB = SystemClass("XE8545_A100-SXM4-40GB", ["A100-SXM4-40GB"], ["20B0"], Architecture.Ampere, [4])
    XE8545_A100_SXM4_80GB = SystemClass("XE8545_A100-SXM4-80GB", ["A100-SXM4-80GB"], ["20B2"], Architecture.Ampere, [4])
