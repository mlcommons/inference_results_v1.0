                      ...
                      size_t buffer_manager_thread_count)
{
    ...
    std::cout << "CREATING NEW PINNED MEMORY POOL WITH: " << std::endl;
    std::cout << "INSTANCE_COUNT: " << instance_count << std::endl;
    std::cout << "MAX BATCH SIZE: " << max_batch_size << std::endl;
    std::cout << "MIN_SAMPLE_SIZE: " << min_sample_size << std::endl;
    std::cout << "output NAMES SIZE: " << output_names.size() << std::endl;
    std::cout << "POOL_ITEM COUNT: " << pool_item_count << std::endl;
    std::cout << "===============================" << std::endl;
    std::cout << "MAX BATCH1 BYTE SIZE " << max_batch1_byte_size << std::endl;
    std::cout << "MAX SAMPLE SIZE: " << max_sample_size << std::endl;
    std::cout << "POOL_ITEM SIZE: " << pool_item_size << std::endl;
...
void Server_SUT::Warmup(double duration_sec, double expected_qps)
{
    ...
    {
        // std::cout << "1" << std::endl;
        // std::cout << "INFERENCES SENT: " << inferences_sent << ", " << "NUM INFERENCES:" <<
        // num_inferences << std::endl; std::cout << "m_UseDlrmQsl: " << m_UseDlrmQsl << std::endl;
        // std::cout << "m_IsDynamic:" << m_IsDynamic << std::endl;
