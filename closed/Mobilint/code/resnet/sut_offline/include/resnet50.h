#ifndef MLPERF_V_1_0_INCLUDE_RESNET50_H_
#define MLPERF_V_1_0_INCLUDE_RESNET50_H_
#include "maccel.h"
#include "loadgen.h"
...
namespace resnet50 {
    ...
    const int IMAGE_SIZE = 224 * 256 * 3;
    ...
    void loadImageNet(const mlperf::QuerySampleIndex* qsi, size_t size);
