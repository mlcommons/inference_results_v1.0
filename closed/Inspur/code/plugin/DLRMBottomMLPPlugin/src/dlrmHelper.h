...
#define CUBLAS_ASSERT(call)                                                                     \
    do                                                                                          \
    {                                                                                           \
        cublasStatus_t cublasStatus = call;                                                     \
        if (cublasStatus != CUBLAS_STATUS_SUCCESS)                                              \
        {                                                                                       \
            reportAssertion("CUBLAS ERROR", __FILE__, __LINE__);                                \
            ASSERT(0);                                                                          \
        }                                                                                       \
    } while (0)
...
#define NVRTC_ASSERT(call)                                                                      \
    do                                                                                          \
    {                                                                                           \
        nvrtcResult nvrtcStatus = call;                                                         \
        if (nvrtcStatus != NVRTC_SUCCESS)                                                       \
        {                                                                                       \
            reportAssertion(nvrtcGetErrorString(nvrtcStatus), __FILE__, __LINE__);              \
            ASSERT(0);                                                                          \
        }                                                                                       \
    } while (0)
